...
export const FISH_LANDMINES: Landmine[] = [
  ...
  // lecture-02-04 씬 25 실측: © (U+00A9) 기호 단독 오독.
  // → "マルシー" 로 변환 (일본어에서 © 의 표준 발음 "丸シー").
  // narration 에서 「©」 처럼 인용 표시 안에 등장하는 패턴이 일반적.
  { pattern: /©/g, from: '©', to: 'マルシー', reason: 'Fish: © (U+00A9) 기호 단독 오독. 일본어 표준 발음 "マルシー" 로 변환' },
