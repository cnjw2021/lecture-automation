...
7. **CodePen typing 씬 사전 점검** (`#box-html .CodeMirror textarea` 또는 `#box-css .CodeMirror textarea` 를 사용하는 모든 씬)
...
8. **검증**
   - `make lint-fix LECTURE=lecture-XX.json`
   - `make lint LECTURE=lecture-XX.json STRICT=1` — G-rule 이 syncPoint 커버리지 검사
